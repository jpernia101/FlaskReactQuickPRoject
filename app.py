...
def submit_form():
    ...
    try:
        ...
        return jsonify({"message": "Form Submitted Succesfully"})
    except Exception as e:
...
def update_form():
    ...
    try:
        ...
        return jsonify({"message": "Form Data Updated Succesfully"})
    except Exception as e:
        return jsonify({"message": "Failed to store form data"}), 500 
...
def verify_user():
    ...
    print(user)
    return jsonify({"message": "Verified", "user_data": result}), 200
